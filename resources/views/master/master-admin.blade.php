...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('image/logo_imam_no_bg.png') }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="60" src="{{ asset('image/logo_imam_no_bg.png') }}">
                <div class="brand-title">
                    <h2 class="">UKM IMAM</h2>
                </div>
            </a>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="copyright">
                    <p><strong>IMAM POLIWANGI </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by Imam Poliwangi</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/piaaasan/" target="_blank">Imam Poliwangi</a>
                </p>
            </div>
        </div>
        <!--**********************************
...
<script>
    $(document).on('change', '.toggle-status', function () {
        ...
        $.ajax({
            url: "{{ route('blog.updateStatus') }}",// "{{ route('photo.updateStatus') }}",  // Pastikan membuat route ini
            method: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
                id: id,
        ...
        $.ajax({
            url: "{{ route('photo.updateStatus') }}",  // Pastikan membuat route ini
            method: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
                id: id,
