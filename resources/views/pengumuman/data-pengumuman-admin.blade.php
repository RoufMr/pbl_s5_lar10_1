                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="save-announcement" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="iduser">Divisi Penerima </label>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="update-announcement/{{ $x->id_pengumuman }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="iduser">Divisi Penerima </label>
                                                                <select class="default-select form-control wide"
                                                                    title="Recipient" name="divisi" required>
                                                                    @if ($x->hasil_seleksi == "LULUS" || $x->hasil_seleksi == "Lulus" || $x->hasil_seleksi == "lulus")
                                                                    <option value="{{ $x->divisi_penerima }}" selected>{{ $x->divisi->nama_divisi }}</option>
                                                                    @endif
                                                                    <option value="{{ $x->pendaftaran->pil1 }}">Pilihan 1 : {{ $x->pendaftaran->pilihan1->nama_divisi }}</option>
                                                                    <option value="{{ $x->pendaftaran->pil2 }}">Pilihan 2 : {{ $x->pendaftaran->pilihan2->nama_divisi }}</option>
