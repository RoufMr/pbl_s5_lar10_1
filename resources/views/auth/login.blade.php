...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('sipenmaru/image/logo.png') }}">
    <link href="{{ asset('sipenmaru/vendor/login/style.css') }}" rel="stylesheet">

    {{-- MATA --}}
    <link href="{{ asset('sipenmaru/vendor/login/app.js')}}"></link>
    ...
    <div class="container">
            ...
            <div class="signin-signup">
                <form method="POST" action="/login" class="sign-in-form">
                    ...
                    <label for="password">{{ __('Password') }}
                        {{-- <span class="small text-dange r">*</span> --}}
                    </label>
                    {{-- <i id="eyeIcon" class="fa fa-eye-slash"></i> --}}
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ asset('image/masjid2.png') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="{{ asset('image/join-imam1.png') }}" class="image" alt="" />
            </div>
        </div>
    </div>
