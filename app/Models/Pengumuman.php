...
class Pengumuman extends Model
{
    ...
    protected $fillable = ["id_pengumuman","user_id","id_pendaftaran","hasil_seleksi","divisi_penerima","nilai_interview","nilai_test","status"];
	...
	public function pendaftaran()
    {
     ...
     {
         return $this->belongsTo(Divisi::class, 'divisi_penerima');
      }
