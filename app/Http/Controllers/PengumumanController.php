...
class PengumumanController extends Controller
{
    ...
    public function datapengumuman()
    {
        ...
        $datadiv = Divisi::all();
        return view ('pengumuman.data-pengumuman-admin',['viewDataUser' => $dataUser,'viewData' => $data,'viewIdPendaftaran' => $dataid,'viewDivisi' => $datadiv]);
    }
    ...
    public function lihatpengumuman(Request $a)
    {
        ...
        return view ('pengumuman.data-pengumuman-view',['viewDataUser' => $dataUser,'viewData' => $data,'viewIdPendaftaran' => $dataid,'viewID' => $dataditemukan]);
    }
    ...
    public function updatepengumuman(Request $a, $id_pengumuman){
        //$dataUser = ProfileUsers::all();
        try{
            $divisi =  preg_replace("/[^0-9]/", "", $a->divisi);
            if($divisi == 0)
            {
                $divisi = null;
            }
